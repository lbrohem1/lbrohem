...
RfuBot=[lineMID]
Family=["u010bb3afc31ec66fa3daa7ae8c7cb15a",lineMID]
admin=['u010bb3afc31ec66fa3daa7ae8c7cb15a',lineMID]
adminMID="u010bb3afc31ec66fa3daa7ae8c7cb15a"
...
settings = {
    ...
    "anu2": "เดะจิ้มตาบอด",
    "autoAdd":False,
    "autoBlock":"บัญชีนี้ได้รับการป้องกันโดย\n🇹🇭─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─🇹🇭\nทางบัญชีจึงขอทำการบล็อค\nเพื่อความปลอดภัยในบัญชี ",
    "autoJoin": False,
    ...
    "Respontag":" แทคเค้าทำไม่ครับ\nเค้าชื่อ 👉เอม ..นะครับ👈ยินดีที่ไม่ รู้จัก\n ─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "ResponPM":"─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "message1":"บัญชีนี้ได้รับการป้องกันโดย\n🇹🇭 ─┅❈͜͡✯นักฆ่าบ้าเชล✯͜͡❈┅─  🇹🇭\nทางบัญชีจึงขอทำการบล็อค\nเพื่อความปลอดภัยในบัญชี 🤖",
    "message":"【─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ 】 :\nList opsi\n🤖 Pasangan Hidup :\n🔰 Only Status 🔰 180K/Bulan\n\n🤖 Systim Contract :\n🔰 Only Curhat 🔰 100K/Bulan\n🔰 Zona Friend + TTM\n🔰 Zona Nyaman + Full Care + On 5day + 2 day free 🔰 300K/Bulan\n\n✍️ Bisa Requests Mau Berapa Lama Durasi Buat Debay.\nChat Ke : http://line.me/ti/p/%40spm7024h\n\n📃\n* Always on 24 Jam\n* Keuntungan Banyak\n* Durasi min 0.25month\n* max no limit", 
    "comment":"─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "Wc":" 👉ยินดีต้อนรับสมาชิกเข้ากลุ่ม 👈 ":" \n   👉(w)(e)(l)(c)(O)(M)(E)👈 \n 📝มาใหม่แก้ผ้าด้วย 📝  \n 🐼แนะนำตัวด้วยงับ🐼 \n 👉📝ชื่อ(..)นามสกุล(..)👈 \n\n👉📝อายุ(..)สถานะ(..)👈 \n  👉📝ที่อยู่(..)จังหวัด(..)👈 \n 👉📝ไปรษณี(..)TO(..) \n 📌เข้ามาก็อย่าดื้อ อย่าซน \n 📌สงสัยไรให้ถาม@นะแจ๊ะ  \n  ─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "bye":"บ๊าย..บาย..สมาชิกได้ออกจากกลุ่มไปแล้ว\nถ้ากลับมาไหม่ยินดี ต้อนดีรับเข้ากลุ่มเสมอ\n ─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "add":"─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "kick":"👉อุ๊..ต๊ะ👈 \n─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "c":"─┅❈͜͡✯ชื่อ เอม คนใต้นราธิวาส✯͜͡❈┅─ ",
    "s":"",
    "userAgent": [
...
def helpset():
    key = settings["s"]
    key = key.title()    
    helpSet = """╭━━{ 【 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  】 }
┣━━━━━━━━━━━━━━━━━
┃{ ─┅❈͜͡✯โหมดคำสั่งตั้งค่า✯͜͡❈┅─ }
┣━━━━━━━━━━━━━━━━━
┃💙┝➣ เปิดแอด/ปิดแอด
...
┃💙┝➣ ลบติ๊กแทค
┣━━━━━━━━━━━━━━━━━
┃•◈➣ ─┅❈͜͡✯หมวดการตั้งค่า API✯͜͡❈┅─
┣━━━━━━━━━━━━━━━━━
┃💙┝➣ ตั้งapi [คีย์เวิร์ด];;[ตอบกลับ]
┃💙┝➣ ล้างapi [คีย์เวร์ด]
┃💙┝➣ เชคapi
┣━━━━━━━━━━━━━━━━━
┃•◈➣ ─┅❈͜͡✯โหมดเช็คค่าข้อความ✯͜͡❈┅─
┣━━━━━━━━━━━━━━━━━
┃💙┝➣ เชคข้อความแทคแชท
┃💙┝➣ เชคข้อความแทค
┃💙┝➣ เชคข้อความแอด
...
def helpsetting():
    key = settings["s"]
    key = key.title()   
    helpSetting = """╭━━{ 【 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  】 }
┣━━━━━━━━━━━━━━━━━
┃    {─┅❈͜͡✯ โหมดคำสั่งกลุ่ม✯͜͡❈┅─}
┣━━━━━━━━━━━━━━━━━
┃💛┝➣ แอด
┃💛┝➣ ไอดีกลุ่ม
┃💛┝➣ รูปกลุ่ม
...
def helpsiri():
    helpSiri = """╭━━━{ 【 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  】 }
┣━━━━━━━━━━━━━━━━
┃      {─┅❈͜͡✯คำสั่งใช้งานบอทสิริ✯͜͡❈┅─}
┃╭━━━━━━━━━━━━━━━
┃┝🖤┝➣ /แอด 
┃┝🖤┝➣ /แอดรอง
┃┝🖤┝➣ /ตั่งค่า
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  』")
...
#------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to, "■•■•■• 3500cc แรงม้า•■•■•■")
                    line.sendMessage(msg.to, "●•➤➤➤➤➤➤➤➤➤➤")
                    line.sendMessage(msg.to, "●•➤➤➤➤➤➤➤➤➤➤➤➤")
                    start = time.time()
                    time.sleep(0.05)
...
#-------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(to, "─┅❈͜͡✯〘บอทยังอยู่จะท่านผู้ชม〙✯͜͡❈┅─\n『✮ 【 вот ☪ ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  】 ✮』")
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "─┅❈͜͡✯ออโต้แอด (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดแอด':
                    settings["autoAdd"] = False
                    line.sendMessage(to, "─┅❈͜͡✯ออโต้แอด (ปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'เปิดบล็อค':
                    settings["autoBlock"] = True
                    line.sendMessage(to, "─┅❈͜͡✯ออโต้บล็อค (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดบล็อค':
                    settings["autoBlock"] = False
                    line.sendMessage(to, "─┅❈͜͡✯ออโต้บล็อค (ปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'เปิดเข้า':
                    settings["autoJoin"] = True
                    line.sendMessage(to, "─┅❈͜͡✯เข้ากลุ่ม (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดเข้า':
                    settings["autoJoin"] = False
                    line.sendMessage(to, "─┅❈͜͡✯เข้ากลุ่ม (ปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'เปิดออก':
                    settings["autoLeave"] = True
                    line.sendMessage(to, "─┅❈͜͡✯ออกแชทรวมอัตโนมัติ (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดออก':
                    settings["autoLeave"] = False
                    line.sendMessage(to, "─┅❈͜͡✯ออกแชทรวมอัตโนมัติ (ปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'เปิดติ๊ก':
                    settings["checkSticker"] = True
                    line.sendMessage(to, "─┅❈͜͡✯อ่านโค๊ดติ๊ก (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดติ๊ก':
                    settings["checkSticker"] = False
                    line.sendMessage(to, "─┅❈͜͡✯อ่านโค๊ดติ๊ก (ปิด) ใช้งาน✯͜͡❈┅─")    
                elif text.lower() == 'เปิดพูด':
                    settings["Api"] = True
                    line.sendMessage(to, "─┅❈͜͡✯อ่านโค๊ดApi (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดพูด':
                    settings["Api"] = False
                    line.sendMessage(to, "─┅❈͜͡✯อ่านโค๊ดApi (ปิด) ใช้งาน✯͜͡❈┅─")  
                elif text.lower() == 'เปิดตรวจสอบ':
                    settings["Aip"] = True
                    line.sendMessage(to, "─┅❈͜͡✯ตรวจสอบคำหยาบ (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดตรวจสอบ':
                    settings["Aip"] = False
                    line.sendMessage(to, "─┅❈͜͡✯ตรวจสอบคำหยาบ (ปิด) ใช้งาน✯͜͡❈┅─") 
                elif text.lower() == 'เปิดสิริ':
                    settings["Siri"] = True
                    line.sendMessage(to, "─┅❈͜͡✯คำสั่งบอทสิริ (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดสิริ':
                    settings["Siri"] = False
                    line.sendMessage(to, "─┅❈͜͡✯คำสั่งบอทสิริ (ปิด) ใช้งาน✯͜͡❈┅─") 
                elif text.lower() == 'เปิดคท.':
                    settings["checkContact"] = True
                    line.sendMessage(to, "─┅❈͜͡✯อ่านคท. (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดคท.':
                    settings["checkSticker"] = False
                    line.sendMessage(to, "─┅❈͜͡✯อ่านคท. (ปิด) ใช้งาน✯͜͡❈┅─")  
                elif text.lower() == 'เปิดอ่าน':
                    settings["autoRead"] = True
                    line.sendMessage(to, "─┅❈͜͡✯อ่านทุกห้อง (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดอ่าน':
                    settings["autoRead"] = False
                    line.sendMessage(to, "─┅❈͜͡✯อ่านทุกห้อง (ปิด) ใช้งาน✯͜͡❈┅─")      
                elif text.lower() == 'เปิดโพส':
                    settings["checkPost"] = True
                    line.sendMessage(to, "─┅❈͜͡✯เชคโพส (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดโพส':
                    settings["checkPost"] = False
                    line.sendMessage(to, "─┅❈͜͡✯เชคโพส (ปิด) ใช้งาน✯͜͡❈┅─")    
                elif text.lower() == 'เปิดมุด':
                    settings["autoJoinTicket"] = True
                    line.sendMessage(to, "─┅❈͜͡✯Autojoin byTicket  enabled.\n\nเปิดออโต้เข้าห้องด้วยลิ้งค์เรียบร้อยแล้ว✯͜͡❈┅─")
                elif text.lower() == 'ปิดมุด':
                    settings["autoJoinTicket"] = False
                    line.sendMessage(to, "─┅❈͜͡✯Autojoin byTicket  disabled.\n\nปิดออโต้เข้าห้องด้วยลิ้งค์เรียบร้อยแล้ว✯͜͡❈┅─")
                elif text.lower() == 'เปิดยกเลิก':
                    settings["unsend"] = True
                    line.sendMessage(to, "─┅❈͜͡✯เชคยกเลิกข้อความ (เปิด) ใช้งาน✯͜͡❈┅─")
                elif text.lower() == 'ปิดยกเลิก':
                    settings["unsend"] = False
                    line.sendMessage(to, "─┅❈͜͡✯เชคยกเลิกข้อความ (ปิด) ใช้งาน✯͜͡❈┅─") 
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        group = line.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            line.sendMessage(to, "─┅❈͜͡✯เปิดลิ้งเรียบร้อย✯͜͡❈┅─")
                        else:
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == True:
                            line.sendMessage(to, "─┅❈͜͡✯ปิดลิ้งเรียบร้อย✯͜͡❈┅─")
                        else:
...
#-------------------------------------------------------------------------------------------------------------
                ...
                elif text.lower() == "─┅❈͜͡✯นักฆ่าบ้าเชล✯͜͡❈┅─ ":
                	_session = requests.session()
                	contact = line.getContact(lineMID)
                	url = "https://game.linefriends.com/jbp-lcs-ranking/lcs/sendMessage"
                	headers = {
...
#==============================================================================#
                ...
                #  if wait["selfbot"] ==True:
                   ...
                   #  try:
                    ...
                    args = msg.text.lower().replace("ลบ ","")
                    mes = 0
                    try:
                        mes = int(args[1])
                    except:
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "『 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ  』\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ 』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『 ہ─═ঈ﷽นักฆ่า﷽ঈ═─ہ 』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
        ...
        if op.type == 26:
            ...
            if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                if msg.toType == 0:
                    ...
                    to = receiver
                if msg.text in ["เอม","นักฆ่า","สุดหล่อ","ที่รัก"]:
                    user = line.getContact(msg._from)
                    sendMessageWithMention(msg.to, user.mid)
