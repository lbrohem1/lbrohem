...
def helpsetting():
    key = settings["s"]
    key = key.title()   
    helpSetting = """╭━━{ 【─┅❈͜͡✯นักฆ่าบ้าเชล✯͜͡❈┅─ 】 }
┣━━━━━━━━━━━━━━━━━
┃    {🔘 โหมดคำสั่งกลุ่ม🔘}
┣━━━━━━━━━━━━━━━━━
┃💛┝➣ แอด
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    start = time.time()
                    line.sendMessage(to, "『─┅❈͜͡✯นักฆ่าบ้าเชล✯͜͡❈┅─ 』")
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "『─┅❈͜͡✯นักฆ่าบ้าเชล✯͜͡❈┅─ 』\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『❌นักฆ่าบ้าเชล❌』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『❌นักฆ่าบ้าเชล❌』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
